...
<?php header("Refresh: 4.3; URL=track3.php"); ?>
...
<?php
echo'<br>
<div style="float:left"><img  src="t2.jpg" width="300" height="300"></div><div style="float:right"><h2>Your food is on the way</h2></div>'; 
