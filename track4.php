...
<?php header("Refresh: 4.3; URL=Home_page.php"); ?>
...
<div id="resp-search-container" class="search-box-area"></div>
    ...
    <img src="t.jpg" />
        ...
        <div class="header-link pr10" style="float:right">
         ...
         <marquee scrollamount='24' width='90%' behavior='slide' style="float:right"><h1 class="h-city-home-title" style="color:White;">
            Tracking your Food        </h1></marquee>
            </div>
...
<?php
echo'<br>
<div style="float:left"><img  src="t4.jpg" width="300" height="300"></div><div style="float:right"><h2>Your Food has been Delivered.Bon Appetite !!!! </h2></div>';  
