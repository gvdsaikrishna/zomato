    ...
    <img src="t.jpg" alt="Best Restaurants in India" />
      ...
      <?php
        ...
        <marquee scrollamount='15' width='80%' behavior='slide'><h1 class='h-city-home-title' style='color:White;'>
            ...
            Welcome to Tomato ..... The online food Store<br>Select your Restaurant from Hyderabad        </h1></marquee>";?>
...
$sql = "select res_name,restaurant_regno from  Restaurant where city='Hyderabad'";
...
echo '<div align="right"><img src="hyd.jpg " width="380" height="240" ></div>';
$n = $_SESSION['login_user'];
$sql = "select item_name from history,Restaurant  where customer_id='$n' and Restaurant.restaurant_regno=history.restaurant_regno and Restaurant.city='Hyderabad'  order by quantity DESC limit 5";
$result = $conn->query($sql);
if($result->num_rows>0)
    {

        echo"<h1>Your Favourites from Hyderabad based on previous purchases :<br></h1>";
        while($row = $result->fetch_assoc()) 
        {
    ...
    {
        echo "<h2>Seems like you have'nt tasted food from Hyderabad<br>Try it out</h2>";
    }
